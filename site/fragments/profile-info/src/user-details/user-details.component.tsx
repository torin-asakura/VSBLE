    ...
    <Column fill>
      ...
      <Row justifyContent='center'>
        <Text fontSize='colossal' color='text.accent' fontWeight='bold' lineHeight='extra'>
          <FormattedMessage id='name.name' defaultMessage='Annija Abzalone' />
        </Text>
      </Row>
      <Layout flexBasis={4} />
      <Row justifyContent='center'>
        <Text fontSize='default' color='text.accent' fontWeight='normal' lineHeight='default'>
          <FormattedMessage id='residence.residence' defaultMessage='Cēsis, Cēsu pilsēta, Latvia' />
        </Text>
      </Row>
      <Layout flexBasis={15} />
      <Row justifyContent='center'>
        <Text fontSize='default' color='text.accent' fontWeight='normal' lineHeight='default'>
          <FormattedMessage id='job.job' defaultMessage='Conceptual & Advertising | Food & Still Life' />
        </Text>
      </Row>
      <Layout flexBasis={8} />
      <Row justifyContent='center'>
        <Link href='https://www.luciaceldran.com'>
          <Text color='text.purple' fontSize='default' lineHeight='default'>
            www.luciaceldran.com
          </Text>
      ...
      <Row justifyContent='center'>
        <Button variant='secondary'>
          <FormattedMessage id='details.edit_profile' defaultMessage='Edit Profile' />
        </Button>
      </Row>
      <Layout flexBasis={24} />
      <Row justifyContent='center'>
        <Layout maxWidth={752}>
          <Text fontSize='default' color='text.accent' fontWeight='normal' lineHeight='extra' textAlign='center'>
            <FormattedMessage id='details.message' defaultMessage='Creative individual with high quality standarts and great passion for showing things in beautiful way. Provide outstanding service and support. Tend to look on things from  many perspectives, to revial all benefits.' />
          </Text>
        </Layout>
      </Row>
    </Column>
